...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ->children()
                ->scalarNode('web_dir')
                    ->info('Absolute path to the web directory.')
                    ->cannotBeEmpty()
                ...
                ->booleanNode('prepend_locale')
                    ->info('Whether or not to use the locale in the URL.')
                    ->defaultFalse()
                ->end()
                ...
                ->arrayNode('image')
                    ...
                    ->children()
                        ...
                        ->scalarNode('target_path')
                            ->info('Using the "contao.image.target_path" parameter has been deprecated and will no longer work in Contao 5.0. Use the "contao.image.target_dir" parameter instead.')
                            ->defaultNull()
                        ->end()
                        ...
                        ->end()
                        ->arrayNode('sizes')
                            ->info('This allows to define image sizes directly in the configuration, rather than just via the tl_image_size table.')
